  <html>
  <head>
		<link href="/styles/multisis-lte/chosen/css/chosen.css" rel="stylesheet">
...
<form>
  ...
  <select id="chosen2" style="width:350px;" multiple class="has_chosen">
    <option value=""></option>
  ...
  <script src="/styles/multisis-lte/chosen/chosen.jquery.js"></script>
  <script src="/jsPrueba.js"></script>
  </html>