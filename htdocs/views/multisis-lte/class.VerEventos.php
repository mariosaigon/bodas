 ...
 **/
 ...
 $this->startBoxPrimary(getMLText("lista_eventos"));
$this->contentContainerStart();
//////INICIO MI CODIGO
?>
 <div class="box">
            <div class="box-header">
              <h3 class="box-title">Ver eventos realizados por la ENAFOP</h3>
            </div>
            <!-- /.box-header -->
                		...
                		//1. nombre
                		 ...
                		 $fin=convertirFecha($res1[$cont]['fecha_fin']);
                		  ...
                		  $idEvento=$res1[$cont]['id'];
                		   echo "<td><a href=\"/out/out.EditarEvento.php?id=".$idEvento."\">Editar evento</a></td>";
                		  //5. enlace para ver confirmaciones
