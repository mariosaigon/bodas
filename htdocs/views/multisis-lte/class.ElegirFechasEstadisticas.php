...
class SeedDMS_View_ElegirFechasEstadisticas extends SeedDMS_Bootstrap_Style 
{
 /**
 ...
 **/
	...
	{ /* {{{ */
		...
		$this->htmlStartPage("Filtro para estadísticas", "skin-blue sidebar-mini  sidebar-collapse");
		$this->containerStart();
		$this->mainHeader();
		$this->mainSideBar();
 ...
 $this->startBoxPrimary("Seleccione rango de fechas para estadísticas");
...
<label>Filtro: </label>
      ...
      <option value="comparativo">Proyecto</option>
