...
$searchAttributes = array();
	...
	function getUsedCategories() { /* {{{ */
		$queryStr = "SELECT * FROM `tblCategory` WHERE `id` IN (SELECT DISTINCT `categoryID` FROM `tblDocumentCategory`) order by `name`";
